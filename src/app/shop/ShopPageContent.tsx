...
const CATEGORY_IMAGE_URL = "https://printinghouseujjain.in/assets/categories/";

const OCCASION_IMAGE_URL = "https://printinghouseujjain.in/assets/occasions/";
    ...
    useEffect(() => {
        const fetchShopData = async () => {
            try {
                ...
                const apiOccasions: ApiOccasion[] = data.occasions || [];
                ...
                const formattedProducts: Product[] = apiProducts.map((product) => {
                    ...
                    return {
                        ...
                        original: Number(product.market_price),

                        image: PRODUCT_IMAGE_URL + product.primary_photo_path,
