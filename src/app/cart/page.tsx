 ...
 * becomes:
 *
 * "20262517dd18144decd9df4545b00cdcc6e55351080755.jpg"
 *
 * Also handles:
 *
...
function cleanCustomizationValue(
    ...
    /*
     * First try to detect an array embedded inside the value.
     *
     * Example:
     *
     * [\"file1.jpg\",\"file2.jpg\"]
        ...
        ([key, rawValue]) => {
            ...
            if (arrayMatch) {
                try {
                    ...
                    console.error(
                        "Unable to parse uploaded image array:",
                        error
                    );
                }
            }
...
function looksLikeImageFilename(
    ...
    /*
     * Remove quotes/brackets that may remain
     * around the filename.
     */
...
function normalizeCartItem(
    ...
    const cartItemId =
        raw.cart_item_id !== undefined &&
        raw.cart_item_id !== null
            ? String(raw.cart_item_id)
            : "";

    if (!cartItemId) {
        console.error(
            "Cart item does not contain cart_item_id:",
            raw
        );
...
/**
 * This function is intentionally NOT used for uploaded
 * images.
 *
 * Backend keys such as:
 *
 * photosome
 * uptofour
 * custom
 *
 * are backend identifiers and should never be shown
 * to the customer.
 */
...
function CartView() {
    ...
    const updateCart = async (
         ...
         * IMPORTANT:
         *
         * Always send cart_item_id.
         *
         * NEVER send product id here.
         */
            ...
            <main className="min-h-screen bg-[#FBF9F7]">
                <div className="mx-auto flex min-h-[calc(100vh-72px)] max-w-4xl items-center justify-center px-5 py-12 sm:px-6">
                    <div className="w-full rounded-3xl border border-[#E8DED7] bg-white px-6 py-14 text-center shadow-[0_12px_45px_rgba(80,40,20,0.06)] sm:px-12">
                        ...
                        <p className="mx-auto mt-3 max-w-md text-sm leading-7 text-[#2E2E2E]/55">
                            Looks like you haven't added anything to your cart. Find something special and make it personal.
                        </p>
